...
describe('InternalTransferSchema', () => {
  ...
  it('accepts source: universal_id with uid_identifier', () =>
    expect(
      InternalTransferSchema.safeParse({
        ...valid,
        source: 'universal_id',
        uid_identifier: 'BOLT-KP-4821',
      }).success,
    ).toBe(true));
  it('rejects universal_id without uid_identifier', () =>
